        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="space-y-2">
                    <h1 className="text-4xl uppercase font-semibold">{event.title}</h1>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <p className="text-sm text-muted-foreground">
                        Share this link with the guests so they can RSVP without creating an account.
                    </p>
                    {inviteUrl ? <div className="rounded-md border border-border bg-(--surface) p-3 text-sm">{inviteUrl}</div> : <p>No invite link generated yet.</p>}
